...
export default function N8nTestPage() {
  ...
  return (
    <main className="flex flex-1 flex-col">
      <AuthShell eyebrow="N8N GEÇİCİ TEST">
        <p className="mb-4 text-[15px] font-semibold leading-[1.4] text-auth-helper">
          Bu sayfa yalnızca n8n webhook test içindir. Vasi doğrulaması yoktur;
          TCKN + PDF doğrudan test URL’sine gider.
        </p>
        ...
        <p className="mt-4 break-all text-center text-[11px] leading-5 text-white/70">
          Hedef: https://n8n.kenankarabulut.com/webhook-test/vasy-verify
        </p>
      </AuthShell>
    </main>
  );
